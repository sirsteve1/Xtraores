xow = {}
xow.path = minetest.get_modpath("xtraores_weapons")

dofile(xow.path .. "/items.lua")
dofile(xow.path .. "/special_weapons.lua")
            ...
            if w_item:get_definition().projectile_attack ~= nil then
                ...
                if xo_wpn_c_down > xo_proj_c_down then
                    ...
                    if not inv:contains_item("main", needed_ammo) then
                        minetest.sound_play("xtraores_empty", {
                            object = player
                        })
                    end
