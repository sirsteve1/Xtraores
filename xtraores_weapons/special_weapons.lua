...
minetest.register_tool("xtraores_weapons:platinum_revolver", {
...
on_use = function(itemstack, user, pointed_thing)
	...
	shooter = user
		...
		if not inv:contains_item("main", "xtraores_weapons:platinum_bullet 1") then
			minetest.sound_play("xtraores_empty", {object=user})
			return itemstack
		end
		if not minetest.setting_getbool("creative_mode") then
			inv:remove_item("main", "xtraores_weapons:platinum_bullet ")
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "xtraores_weapons:platinumshot")
			if obj then
			...
			pos.y = pos.y - 0.2
			local obj = minetest.add_entity(pos, "xtraores_weapons:gunsmoke")
				minetest.sound_play("xtraores_revolver", {object=obj})
...
local xtraores_platinumshot = {
	...
	textures = {'xtraores_weapons:platinum_shot'},
	lastpos= {},
	...
	if self.timer > 0.10 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:platinumshot" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 6
...
minetest.register_entity("xtraores_weapons:platinumshot", xtraores_platinumshot)

minetest.register_craftitem("xtraores_weapons:platinum_shot", {
	inventory_image = "xtraores_platinum_shot.png",
})

minetest.register_craftitem("xtraores_weapons:platinum_bullet", {
...
minetest.register_craft( {
	type = "shapeless",
	output = "xtraores_weapons:platinum_revolver",
	recipe = {"xtraores_weapons:platinum_revolver_base", "xtraores_weapons:platinum_mag", "xtraores_weapons:revolver_handle"},
})

minetest.register_craft({
	output = 'xtraores_weapons:platinum_bullet 25',
	recipe = {
		{'', 'default:gold_ingot', ''},
...
minetest.register_tool("xtraores_weapons:cobalt_handgun", {
	...
	shooter = user
		meta:set_int("xo_weapon_cooldown",0)
		local inv = user:get_inventory()
		if not inv:contains_item("main", "xtraores_weapons:cobalt_bullet 1") then
			minetest.sound_play("xtraores_empty", {object=user})
			return itemstack
		end
		if not minetest.setting_getbool("creative_mode") then
			inv:remove_item("main", "xtraores_weapons:cobalt_bullet ")
itemstack:add_wear(65535/1750)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "xtraores_weapons:cobaltshot")
			if obj then
...
local xtraores_cobaltshot = {
	...
	visual = "wielditem",
	visual_size = {x=0.25, y=0.4,},
	textures = {'xtraores_weapons:cobalt_shot'},
	lastpos= {},
	collisionbox = {0, 0, 0, 0, 0, 0},
}
xtraores_cobaltshot.on_step = function(self, dtime)
	...
	if self.timer > 0.07 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:cobaltshot" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 12
					obj:punch(shooter, 1.0, {
						full_punch_interval = 1.0,
						damage_groups= {fleshy = damage},
...
minetest.register_entity("xtraores_weapons:cobaltshot", xtraores_cobaltshot)

minetest.register_craftitem("xtraores_weapons:cobalt_shot", {
	inventory_image = "xtraores_cobalt_shot.png",
})

minetest.register_craftitem("xtraores_weapons:cobalt_bullet", {
...
minetest.register_craft( {
	type = "shapeless",
	output = "xtraores_weapons:cobalt_handgun",
	recipe = {"xtraores_weapons:cobalt_top", "xtraores_weapons:cobalt_base", "xtraores_weapons:cobalt_handle"},
})

minetest.register_craft({
	output = 'xtraores_weapons:cobalt_bullet 25',
	recipe = {
		{'', 'xtraores:cobalt_bar', ''},
		{'', 'xtraores:cobalt_bar', ''},
...
minetest.register_tool("xtraores_weapons:orichalcum_rifle", {
	...
	shooter = user
		meta:set_int("xo_weapon_cooldown",0)
		local inv = user:get_inventory()
		if not inv:contains_item("main", "xtraores_weapons:orichalcum_bullet 1") then
			minetest.sound_play("xtraores_empty", {object=user})
			return itemstack
		end
		if not minetest.setting_getbool("creative_mode") then
			inv:remove_item("main", "xtraores_weapons:orichalcum_bullet ")
itemstack:add_wear(65535/9001)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "xtraores_weapons:orichalcumshot")
			if obj then
...
local xtraores_orichalcumshot = {
	...
	textures = {'xtraores_weapons:orichalcum_shot'},
	lastpos= {},
	collisionbox = {0, 0, 0, 0, 0, 0},
}
xtraores_orichalcumshot.on_step = function(self, dtime)
	...
	if self.timer > 0.05 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:orichalcumshot" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 26
					obj:punch(shooter, 1.0, {
						full_punch_interval = 1.0,
						damage_groups= {fleshy = damage},
...
minetest.register_entity("xtraores_weapons:orichalcumshot", xtraores_orichalcumshot)

minetest.register_craftitem("xtraores_weapons:orichalcum_shot", {
	inventory_image = "xtraores_orichalcum_shot.png",
	wield_scale = {x=2.0,y=1.0,z=1.0},
})

minetest.register_craftitem("xtraores_weapons:orichalcum_bullet", {
...
minetest.register_craft( {
	type = "shapeless",
	output = "xtraores_weapons:orichalcum_rifle",
	recipe = {"xtraores_weapons:orichalcum_rifle_barrel", "xtraores_weapons:orichalcum_rifle_scope", "xtraores_weapons:orichalcum_rifle_base", "xtraores_weapons:orichalcum_rifle_stock", "xtraores_weapons:orichalcum_rifle_grip",
"xtraores_weapons:orichalcum_rifle_handle" },
})

minetest.register_craft({
	output = 'xtraores_weapons:orichalcum_bullet 30',
	recipe = {
...
xtraores_gunsmoke.on_step = function(self, dtime)
	...
	if self.timer > 1 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:gunsmoke" and obj:get_luaentity().name ~= "__builtin:item" then
...
minetest.register_entity("xtraores_weapons:gunsmoke", xtraores_gunsmoke)


minetest.register_tool("xtraores_weapons:sword_radioactive", {
	...
	projectile_attack = "xtraores_weapons:radioactive_ray",
...
minetest.register_craft({
	output = 'xtraores_weapons:sword_radioactive',
	recipe = {
...
local xtraores_radioactive_ray = {
	...
	visual = "wielditem",
	visual_size = {x=0.4, y=0.8,},
	textures = {"xtraores_weapons:radioactive_ray_shot"},
	lastpos= {},
	collisionbox = {0, 0, 0, 0, 0, 0},
}
xtraores_radioactive_ray.on_step = function(self, dtime)
	...
	if self.timer > 0.1 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:radioactive_ray" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 15
					obj:punch(shooter, 1.0, {
						full_punch_interval = 1.0,
						damage_groups= {fleshy = damage},
...
minetest.register_entity("xtraores_weapons:radioactive_ray", xtraores_radioactive_ray)

minetest.register_craftitem("xtraores_weapons:radioactive_ray_shot", {
...
minetest.register_tool("xtraores_weapons:titanium_machinegun", {
	...
	projectile_attack = "xtraores_weapons:titaniumshot_machinegun",
	projectile_sound = "xtraores_machinegun",
	needed_ammo = "xtraores_weapons:titanium_bullet 1",
	consumed_ammo = 0,
...
minetest.register_tool("xtraores_weapons:titanium_handgun", {
	...
	shooter = user
		meta:set_int("xo_weapon_cooldown",0)
		local inv = user:get_inventory()
		if not inv:contains_item("main", "xtraores_weapons:titanium_bullet 1") then
			minetest.sound_play("xtraores_empty", {object=user})
			return itemstack
		end
		if not minetest.setting_getbool("creative_mode") then
			inv:remove_item("main", "xtraores_weapons:titanium_bullet ")
itemstack:add_wear(65535/20000)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "xtraores_weapons:titaniumshot_handgun")
			if obj then
				minetest.sound_play("xtraores_handgun", {object=obj})
...
local xtraores_titaniumshot_handgun = {
	...
	visual = "wielditem",
	visual_size = {x=0.25, y=0.4,},
	textures = {'xtraores_weapons:titanium_shot'},
	lastpos= {},
	collisionbox = {0, 0, 0, 0, 0, 0},
}
xtraores_titaniumshot_handgun.on_step = function(self, dtime)
	...
	if self.timer > 0.08 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:titaniumshot_handgun" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 28
					obj:punch(shooter, 1.0, {
						full_punch_interval = 1.0,
						damage_groups= {fleshy = damage},
...
minetest.register_entity("xtraores_weapons:titaniumshot_handgun", xtraores_titaniumshot_handgun)
...
xtraores_titaniumshot_machinegun.on_step = function(self, dtime)
	...
	if self.timer > 0.1 then
		...
		for k, obj in pairs(objs) do
			if obj:get_luaentity() ~= nil then
				if obj:get_luaentity().name ~= "xtraores_weapons:titaniumshot_machinegun" and obj:get_luaentity().name ~= "__builtin:item" then
					local damage = 22
					obj:punch(shooter, 1.0, {
						full_punch_interval = 1.0,
						damage_groups= {fleshy = damage},
...
minetest.register_entity("xtraores_weapons:titaniumshot_machinegun", xtraores_titaniumshot_machinegun)


minetest.register_craftitem("xtraores_weapons:titanium_shot", {
	inventory_image = "xtraores_titanium_shot.png",
})

minetest.register_craftitem("xtraores_weapons:titanium_bullet", {
...
minetest.register_craft( {
	type = "shapeless",
	output = "xtraores_weapons:titanium_handgun",
	recipe = {"xtraores_weapons:titanium_gun_barrel","xtraores_weapons:titanium_handgun_base", "xtraores_weapons:titanium_gun_handle"},
})

minetest.register_craft( {
	type = "shapeless",
	output = "xtraores_weapons:titanium_machinegun",
	recipe = {"xtraores_weapons:titanium_gun_barrel","xtraores_weapons:titanium_machinegun_base","xtraores_weapons:titanium_machinegun_stock","xtraores_weapons:titanium_gun_barrel","xtraores_weapons:titanium_machinegun_mag","xtraores_weapons:titanium_gun_handle"},
})


minetest.register_craft({
	output = 'xtraores_weapons:titanium_bullet 100',
	recipe = {
		{'', 'default:diamond', ''},
